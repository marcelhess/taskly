...
import { Badge, Box, Flex, Heading, Stack, Text, Link, Card, CardBody, useDisclosure } from "@chakra-ui/react";
...
return (
   <Box p="2" maxW="lg" mx="auto">
      ...
      <Flex justify="space-between" mt="5">
         ...
         <Link as={RouterLink} to={`/update-task/${task._id}`} color="teal" _hover={{ textDecor: "none" }}>
            Edit Task
         </Link>
      </Flex>
      <DeleteConfirmation
